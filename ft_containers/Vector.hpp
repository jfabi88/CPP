...
/**-*-*-*-*-MEMBERS TYPE-*-*-*-*-**/
    ...
    class const_reverse_FtIterator
    {
        ...
        const FtIterator& operator=(const FtIterator&);
    ...
    typedef typename Alloc::difference_type difference_type;
    typedef typename Alloc::size_type syze_type;
...
/**-*-*-*-*-MEMBERS FUNCTIONS-*-*-*-*-**/
    ...
    const_reference operator[] (syze_type n) const;
    reference       at (size_type n);
    const_reference at (syze_type n) const;
    reference       front();
    ...
    void        assign (syze_type n, const value_type& val);
    void        push_back (const value_type& val);
    void        pop_back();
    FtIterator    insert (FtIterator position, const value_type& val);
    void        insert (FtIterator position, syze_type n, const value_type& val);
    template <class InputFtIterator>
